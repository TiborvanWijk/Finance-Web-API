    ...
    public partial class DatabaseMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorizedUsers", x => new { x.OwnerId, x.AuthorizedUserId });
                    table.ForeignKey(
                        name: "FK_AuthorizedUsers_AspNetUsers_AuthorizedUserId",
                        column: x => x.AuthorizedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AuthorizedUsers_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorizeUserInvite", x => new { x.OwnerId, x.AuthorizedUserId });
                    table.ForeignKey(
                        name: "FK_AuthorizeUserInvite_AspNetUsers_AuthorizedUserId",
                        column: x => x.AuthorizedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AuthorizeUserInvite_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AuthorizedUserJoinAuthorizedUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AuthorizedUserJoinOwnerId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetRoles_AuthorizedUsers_AuthorizedUserJoinOwnerId_AuthorizedUserJoinAuthorizedUserId",
                        columns: x => new { x.AuthorizedUserJoinOwnerId, x.AuthorizedUserJoinAuthorizedUserId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_AuthorizedUserJoinOwnerId_AuthorizedUserJoinAuthorizedUserId",
                table: "AspNetRoles",
                columns: new[] { "AuthorizedUserJoinOwnerId", "AuthorizedUserJoinAuthorizedUserId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorizedUsers_AuthorizedUserId",
                table: "AuthorizedUsers",
                column: "AuthorizedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AuthorizeUserInvite_AuthorizedUserId",
                table: "AuthorizeUserInvite",
                column: "AuthorizedUserId");
